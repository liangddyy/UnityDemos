...
function Start 					() {												// initialize everything
	...
	(GetComponent.<Animation>() [ "targetEnemy" ]as AnimationClip).wrapMode = WrapMode.Once;							// set animation to play once
	(GetComponent.<Animation>() [ "walk" ]as AnimationClip).wrapMode 		 = WrapMode.Once;							// set animation to play once
	(GetComponent.<Animation>() [ "die" ]as AnimationClip).wrapMode  		 = WrapMode.Once;							// set animation to play once
	(GetComponent.<Animation>() [ "die" ]as AnimationClip).layer 			 = 1;										// set animation priority high
